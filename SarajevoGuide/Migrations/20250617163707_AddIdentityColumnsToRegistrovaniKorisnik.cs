...
{
    /// <inheritdoc />
    public partial class AddIdentityColumnsToRegistrovaniKorisnik : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_RegistrovaniKorisnik_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_RegistrovaniKorisnik_UserId",
                        column: x => x.UserId,
                        principalTable: "RegistrovaniKorisnik",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_RegistrovaniKorisnik_UserId",
                        column: x => x.UserId,
                        principalTable: "RegistrovaniKorisnik",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_RegistrovaniKorisnik_UserId",
                        column: x => x.UserId,
                        principalTable: "RegistrovaniKorisnik",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookmark_RegistrovaniKorisnik_UserId1",
                        column: x => x.UserId1,
                        principalTable: "RegistrovaniKorisnik",
                        principalColumn: "Id");
                });
